...
class ParametersTagsExtendsExtParam extends WGParameters
{
...
class ParametersTagsExtendsBaseParam extends ParametersTagsExtendsExtParam
{
...
class ParametersTagsExtendsTest extends TestCase
{
	public function test_int_v1()
	{
		...
		$g = new ParametersTagsExtendsBaseParam( null );
		$g->initByDefault();
